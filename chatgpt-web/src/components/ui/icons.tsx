...
export const NewIcon: FC<SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg aria-hidden="true" focusable="false" className={cx("w-6 h-6", className)} viewBox="0 0 20 20" fill="currentColor" {...props}>
