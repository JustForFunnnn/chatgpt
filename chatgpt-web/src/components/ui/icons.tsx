...
export const ScrollDownIcon: FC<SVGProps<SVGSVGElement>> = ({
  className,
  ...props
}) => (
  <svg
...
export const LoadingIcon: FC<SVGProps<SVGSVGElement>> = ({
  className,
  ...props
}) => (
  <svg
    ...
    focusable="false"
    className={cx(
      "w-10 h-10 animate-spin text-blue-500 mx-auto mb-4",
      className,
    )}
...
export const NewIcon: FC<SVGProps<SVGSVGElement>> = ({
  className,
  ...props
}) => (
  <svg
...
export const LockIcon: FC<SVGProps<SVGSVGElement>> = ({
  className,
  ...props
}) => (
  <svg
...
export const ErrorIcon: FC<SVGProps<SVGSVGElement>> = ({
  className,
  ...props
}) => (
  <svg
